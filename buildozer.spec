...
title = Sailing Supervisor

# (str) Package name
package.name = sailingSupervisor

# (str) Package domain (needed for android/ios packaging)
package.domain = org.aoct.SailingSupervisor
...
requirements = hostpython2 ,kivy, android, jnius, kivmob, plyer
